        ...
        <div class="container mx-auto">
            <div class="flex justify-between items-center">
                ...
                <div class="w-3/5 relative">
                    <input v-model="searchKey" type="text" class="w-full rounded-md border focus:outline-none border-solid border-slate-300 h-10 pl-5 pr-9 pt-2 pb-2 relative" placeholder="Find your product">
