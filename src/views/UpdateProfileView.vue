            ...
            <div class="">
                <form @submit="updateProfile()">
                    <div class="mb-3">
                        ...
                        <input type="text" v-model="name" class="rounded-md border focus:outline-none border-solid border-slate-300 h-10 w-[500px] p-5" id="exampleInputEmail1" aria-describedby="emailHelp" :readonly="!isUpdated">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="block mb-3">Email</label>
                        <input type="email" v-model="email" class="rounded-md border focus:outline-none border-solid border-slate-300 h-10 w-[500px] p-5" id="exampleInputPassword1" :readonly="!isUpdated">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="block mb-3">Address</label>
                        <input type="text" v-model="address" class="rounded-md border focus:outline-none border-solid border-slate-300 h-10 w-[500px] p-5" id="exampleInputPassword1" :readonly="!isUpdated">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="block mb-3">Contact Number</label>
                        <input type="text" v-model="contactNumber" class="rounded-md border focus:outline-none border-solid border-slate-300 h-10 w-[500px] p-5" id="exampleInputPassword1" :readonly="!isUpdated">
                    </div>
